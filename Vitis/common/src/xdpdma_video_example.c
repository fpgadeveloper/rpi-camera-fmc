...
// Opsero mod start
/*
// We have replaced the main function
int main()
{
	int Status;
...
// Opsero mod start
	InitRunConfig(RunCfgPtr,Intr,mode);
// Opsero mod end
...
// Opsero mod start: not using graphics channel
...
// Opsero mod end
	 ...
	 */
// Opsero mod start: select live video, not using graphics channel
...
// Opsero mod start: interrupt controller should already be initialized
...
// Opsero mod start: exceptions should already be initialized
/*
	Xil_ExceptionInit();
...
// Opsero mod start: exceptions should already be enabled
/*
