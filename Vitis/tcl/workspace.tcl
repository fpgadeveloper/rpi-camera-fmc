...
proc microblaze_boot_files {vivado_path app_name proc_instance} {
  ...
  if {$mb_combine_bit_elf} {
    ...
    exec updatemem --bit "${vivado_path}/${vivado_folder}.runs/impl_1/${design_prefix}_wrapper.bit" \
      --meminfo "${vivado_path}/${vivado_folder}.runs/impl_1/${design_prefix}_wrapper.mmi" \
    ...
    file copy "${vivado_path}/${vivado_folder}.runs/impl_1/${design_prefix}_wrapper.bit" "./boot/${vivado_folder}"
