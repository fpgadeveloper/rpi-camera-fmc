...
set_property PACKAGE_PIN K4 [get_ports iic_0_scl_io]; # LA03_P
set_property PACKAGE_PIN K3 [get_ports iic_0_sda_io]; # LA03_N
...
set_property PACKAGE_PIN K2 [get_ports iic_1_scl_io]; # LA04_P
set_property PACKAGE_PIN J2 [get_ports iic_1_sda_io]; # LA04_N
...
set_property PACKAGE_PIN AC4 [get_ports iic_2_scl_io]; # LA19_P
set_property PACKAGE_PIN AC3 [get_ports iic_2_sda_io]; # LA19_N
...
# PIN_SWAP signals
set_property PACKAGE_PIN R6 [get_ports {pin_swap[0]}]; # LA05_P
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[0]}]

set_property PACKAGE_PIN T6 [get_ports {pin_swap[1]}]; # LA05_N
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[1]}]

# GPIOs for MIPI camera 0
set_property PACKAGE_PIN K9 [get_ports {gpio_0_tri_o[0]}]; # LA07_P
set_property PACKAGE_PIN J9 [get_ports {gpio_0_tri_o[1]}]; # LA07_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_0_tri_o[*]}]

# GPIOs for MIPI camera 1
set_property PACKAGE_PIN M8 [get_ports {gpio_1_tri_o[0]}]; # LA09_P
set_property PACKAGE_PIN L8 [get_ports {gpio_1_tri_o[1]}]; # LA09_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_1_tri_o[*]}]

# GPIOs for MIPI camera 2
set_property PACKAGE_PIN AB7 [get_ports {gpio_2_tri_o[0]}]; # LA30_P
set_property PACKAGE_PIN AC7 [get_ports {gpio_2_tri_o[1]}]; # LA30_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_2_tri_o[*]}]

# GPIOs for MIPI camera 3
set_property PACKAGE_PIN AB2 [get_ports {gpio_3_tri_o[0]}]; # LA32_P
set_property PACKAGE_PIN AC2 [get_ports {gpio_3_tri_o[1]}]; # LA32_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_3_tri_o[*]}]

# Reserved GPIOs
set_property PACKAGE_PIN J7 [get_ports {rsvd_gpio_tri_o[0]}]; # LA12_P
set_property PACKAGE_PIN H7 [get_ports {rsvd_gpio_tri_o[1]}]; # LA12_N
set_property PACKAGE_PIN N7 [get_ports {rsvd_gpio_tri_o[2]}]; # LA13_P
set_property PACKAGE_PIN N6 [get_ports {rsvd_gpio_tri_o[3]}]; # LA13_N
set_property PACKAGE_PIN AB8 [get_ports {rsvd_gpio_tri_o[4]}]; # LA22_P
set_property PACKAGE_PIN AC8 [get_ports {rsvd_gpio_tri_o[5]}]; # LA22_N
set_property PACKAGE_PIN AG3 [get_ports {rsvd_gpio_tri_o[6]}]; # LA25_P
set_property PACKAGE_PIN AH3 [get_ports {rsvd_gpio_tri_o[7]}]; # LA25_N
set_property PACKAGE_PIN AG4 [get_ports {rsvd_gpio_tri_o[8]}]; # LA27_P
set_property PACKAGE_PIN AH4 [get_ports {rsvd_gpio_tri_o[9]}]; # LA27_N
set_property PACKAGE_PIN AH8 [get_ports {rsvd_gpio_tri_o[10]}]; # LA29_P
set_property PACKAGE_PIN AH7 [get_ports {rsvd_gpio_tri_o[11]}]; # LA29_N
...
set_property PACKAGE_PIN J6 [get_ports {mipi_phy_if_0_data_p[0]}]; # LA02_P
set_property PACKAGE_PIN H6 [get_ports {mipi_phy_if_0_data_n[0]}]; # LA02_N
set_property PACKAGE_PIN L1 [get_ports {mipi_phy_if_0_data_p[1]}]; # LA06_P
set_property PACKAGE_PIN K1 [get_ports {mipi_phy_if_0_data_n[1]}]; # LA06_N
...
set_property PACKAGE_PIN P7 [get_ports {mipi_phy_if_1_data_p[0]}]; # LA14_P
set_property PACKAGE_PIN P6 [get_ports {mipi_phy_if_1_data_n[0]}]; # LA14_N
set_property PACKAGE_PIN R8 [get_ports {mipi_phy_if_1_data_p[1]}]; # LA15_P
set_property PACKAGE_PIN T8 [get_ports {mipi_phy_if_1_data_n[1]}]; # LA15_N
...
set_property PACKAGE_PIN AD2 [get_ports {mipi_phy_if_2_data_p[0]}]; # LA17_CC_P
set_property PACKAGE_PIN AD1 [get_ports {mipi_phy_if_2_data_n[0]}]; # LA17_CC_N
set_property PACKAGE_PIN AF7 [get_ports {mipi_phy_if_2_data_p[1]}]; # LA24_P
set_property PACKAGE_PIN AF6 [get_ports {mipi_phy_if_2_data_n[1]}]; # LA24_N
...
set_property PACKAGE_PIN AE9 [get_ports {mipi_phy_if_3_data_p[0]}]; # LA28_P
set_property PACKAGE_PIN AE8 [get_ports {mipi_phy_if_3_data_n[0]}]; # LA28_N
set_property PACKAGE_PIN AB6 [get_ports {mipi_phy_if_3_data_p[1]}]; # LA33_P
set_property PACKAGE_PIN AC6 [get_ports {mipi_phy_if_3_data_n[1]}]; # LA33_N
