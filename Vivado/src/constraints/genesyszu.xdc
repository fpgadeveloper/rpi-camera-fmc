...
set_property PACKAGE_PIN J6 [get_ports iic_0_scl_io]; # LA02_P
set_property PACKAGE_PIN H6 [get_ports iic_0_sda_io]; # LA02_N
...
set_property PACKAGE_PIN R6 [get_ports iic_1_scl_io]; # LA05_P
set_property PACKAGE_PIN T6 [get_ports iic_1_sda_io]; # LA05_N
...
# PIN_SWAP signals
set_property PACKAGE_PIN K9 [get_ports {pin_swap[0]}]; # LA07_P
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[0]}]

set_property PACKAGE_PIN J9 [get_ports {pin_swap[1]}]; # LA07_N
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[1]}]

set_property PACKAGE_PIN AC9 [get_ports {pin_swap[2]}]; # LA26_P
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[2]}]

# GPIOs for MIPI camera 0
set_property PACKAGE_PIN R8 [get_ports {gpio_0_tri_o[0]}]; # LA15_P
set_property PACKAGE_PIN T8 [get_ports {gpio_0_tri_o[1]}]; # LA15_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_0_tri_o[*]}]

# GPIOs for MIPI camera 1
set_property PACKAGE_PIN K8 [get_ports {gpio_1_tri_o[0]}]; # LA16_P
set_property PACKAGE_PIN K7 [get_ports {gpio_1_tri_o[1]}]; # LA16_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_1_tri_o[*]}]

# GPIOs for MIPI camera 2
set_property PACKAGE_PIN AE9 [get_ports {gpio_2_tri_o[0]}]; # LA28_P
set_property PACKAGE_PIN AE8 [get_ports {gpio_2_tri_o[1]}]; # LA28_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_2_tri_o[*]}]

# GPIOs for MIPI camera 3
set_property PACKAGE_PIN AH8 [get_ports {gpio_3_tri_o[0]}]; # LA29_P
set_property PACKAGE_PIN AH7 [get_ports {gpio_3_tri_o[1]}]; # LA29_N
...
set_property PACKAGE_PIN K4 [get_ports {mipi_phy_if_0_data_p[0]}]; # LA03_P
set_property PACKAGE_PIN K3 [get_ports {mipi_phy_if_0_data_n[0]}]; # LA03_N
set_property PACKAGE_PIN K2 [get_ports {mipi_phy_if_0_data_p[1]}]; # LA04_P
set_property PACKAGE_PIN J2 [get_ports {mipi_phy_if_0_data_n[1]}]; # LA04_N
...
set_property PACKAGE_PIN J7 [get_ports {mipi_phy_if_1_data_p[0]}]; # LA12_P
set_property PACKAGE_PIN H7 [get_ports {mipi_phy_if_1_data_n[0]}]; # LA12_N
set_property PACKAGE_PIN N7 [get_ports {mipi_phy_if_1_data_p[1]}]; # LA13_P
set_property PACKAGE_PIN N6 [get_ports {mipi_phy_if_1_data_n[1]}]; # LA13_N
...
set_property PACKAGE_PIN AG3 [get_ports {mipi_phy_if_2_data_p[1]}]; # LA25_P
set_property PACKAGE_PIN AH3 [get_ports {mipi_phy_if_2_data_n[1]}]; # LA25_N
...
set_property PACKAGE_PIN AB8 [get_ports {mipi_phy_if_3_data_p[1]}]; # LA22_P
set_property PACKAGE_PIN AC8 [get_ports {mipi_phy_if_3_data_n[1]}]; # LA22_N
