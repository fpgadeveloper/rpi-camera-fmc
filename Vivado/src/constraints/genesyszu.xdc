...
set_property PACKAGE_PIN AB8 [get_ports {gpio_2_tri_o[0]}]; # LA22_P
set_property PACKAGE_PIN AC8 [get_ports {gpio_2_tri_o[1]}]; # LA22_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_2_tri_o[*]}]

# GPIOs for MIPI camera 3
set_property PACKAGE_PIN AG3 [get_ports {gpio_3_tri_o[0]}]; # LA25_P
set_property PACKAGE_PIN AH3 [get_ports {gpio_3_tri_o[1]}]; # LA25_N
