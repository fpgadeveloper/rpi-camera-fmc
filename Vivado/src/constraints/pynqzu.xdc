...
set_property PACKAGE_PIN H8 [get_ports iic_1_scl_io]; # LA04_N
set_property PACKAGE_PIN H9 [get_ports iic_1_sda_io]; # LA04_P
...
set_property PACKAGE_PIN J1 [get_ports {clk_sel[0]}]; # LA05_P
set_property IOSTANDARD LVCMOS12 [get_ports {clk_sel[0]}]

set_property PACKAGE_PIN H1 [get_ports {clk_sel[1]}]; # LA05_N
...
# Reserved GPIOs
set_property PACKAGE_PIN J6 [get_ports {rsvd_gpio_tri_o[0]}]; # LA07_P
set_property PACKAGE_PIN H6 [get_ports {rsvd_gpio_tri_o[1]}]; # LA07_N
...
set_property PACKAGE_PIN AH2 [get_ports {rsvd_gpio_tri_o[4]}]; # LA25_P
set_property PACKAGE_PIN AH1 [get_ports {rsvd_gpio_tri_o[5]}]; # LA25_N
