...
set_property PACKAGE_PIN K8 [get_ports iic_0_scl_io]; # LA02_P
set_property PACKAGE_PIN K7 [get_ports iic_0_sda_io]; # LA02_N
...
set_property PACKAGE_PIN J1 [get_ports iic_1_scl_io]; # LA05_P
set_property PACKAGE_PIN H1 [get_ports iic_1_sda_io]; # LA05_N
...
# PIN_SWAP signals
set_property PACKAGE_PIN J6 [get_ports {pin_swap[0]}]; # LA07_P
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[0]}]

set_property PACKAGE_PIN H6 [get_ports {pin_swap[1]}]; # LA07_N
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[1]}]

set_property PACKAGE_PIN AF1 [get_ports {pin_swap[2]}]; # LA26_P
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[2]}]

# GPIOs for MIPI camera 0
set_property PACKAGE_PIN N9 [get_ports {gpio_0_tri_o[0]}]; # LA15_P
set_property PACKAGE_PIN N8 [get_ports {gpio_0_tri_o[1]}]; # LA15_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_0_tri_o[*]}]

# GPIOs for MIPI camera 1
set_property PACKAGE_PIN M8 [get_ports {gpio_1_tri_o[0]}]; # LA16_P
set_property PACKAGE_PIN L8 [get_ports {gpio_1_tri_o[1]}]; # LA16_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_1_tri_o[*]}]

# GPIOs for MIPI camera 2
set_property PACKAGE_PIN AG6 [get_ports {gpio_2_tri_o[0]}]; # LA28_P
set_property PACKAGE_PIN AG5 [get_ports {gpio_2_tri_o[1]}]; # LA28_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_2_tri_o[*]}]

# GPIOs for MIPI camera 3
set_property PACKAGE_PIN AG4 [get_ports {gpio_3_tri_o[0]}]; # LA29_P
set_property PACKAGE_PIN AH4 [get_ports {gpio_3_tri_o[1]}]; # LA29_N
...
set_property PACKAGE_PIN K9 [get_ports {mipi_phy_if_0_data_p[0]}]; # LA03_P
set_property PACKAGE_PIN J9 [get_ports {mipi_phy_if_0_data_n[0]}]; # LA03_N
...
set_property PACKAGE_PIN M6 [get_ports {mipi_phy_if_1_data_p[0]}]; # LA12_P
set_property PACKAGE_PIN L5 [get_ports {mipi_phy_if_1_data_n[0]}]; # LA12_N
set_property PACKAGE_PIN R6 [get_ports {mipi_phy_if_1_data_p[1]}]; # LA13_P
set_property PACKAGE_PIN T6 [get_ports {mipi_phy_if_1_data_n[1]}]; # LA13_N
...
set_property PACKAGE_PIN AB1 [get_ports {mipi_phy_if_3_data_p[1]}]; # LA22_P
set_property PACKAGE_PIN AC1 [get_ports {mipi_phy_if_3_data_n[1]}]; # LA22_N
