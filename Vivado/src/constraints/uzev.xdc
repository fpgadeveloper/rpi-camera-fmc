...
set_property PACKAGE_PIN AE18 [get_ports iic_0_scl_io]; # LA03_P
set_property PACKAGE_PIN AF18 [get_ports iic_0_sda_io]; # LA03_N
...
set_property PACKAGE_PIN AH17 [get_ports iic_1_scl_io]; # LA04_P
set_property PACKAGE_PIN AJ17 [get_ports iic_1_sda_io]; # LA04_N
...
set_property PACKAGE_PIN AF10 [get_ports iic_2_scl_io]; # LA19_P
set_property PACKAGE_PIN AG10 [get_ports iic_2_sda_io]; # LA19_N
...
set_property PACKAGE_PIN AJ10 [get_ports iic_3_scl_io]; # LA20_P
set_property PACKAGE_PIN AK10 [get_ports iic_3_sda_io]; # LA20_N
...
# PIN_SWAP signals
set_property PACKAGE_PIN AD19 [get_ports {pin_swap[0]}]; # LA05_P
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[0]}]

set_property PACKAGE_PIN AE19 [get_ports {pin_swap[1]}]; # LA05_N
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[1]}]

# GPIOs for MIPI camera 0
set_property PACKAGE_PIN AA16 [get_ports {gpio_0_tri_o[0]}]; # LA07_P
set_property PACKAGE_PIN AB16 [get_ports {gpio_0_tri_o[1]}]; # LA07_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_0_tri_o[*]}]

# GPIOs for MIPI camera 1
set_property PACKAGE_PIN AK17 [get_ports {gpio_1_tri_o[0]}]; # LA09_P
set_property PACKAGE_PIN AK18 [get_ports {gpio_1_tri_o[1]}]; # LA09_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_1_tri_o[*]}]

# GPIOs for MIPI camera 2
set_property PACKAGE_PIN AJ2 [get_ports {gpio_2_tri_o[0]}]; # LA30_P
set_property PACKAGE_PIN AJ1 [get_ports {gpio_2_tri_o[1]}]; # LA30_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_2_tri_o[*]}]

# GPIOs for MIPI camera 3
set_property PACKAGE_PIN AH9 [get_ports {gpio_3_tri_o[0]}]; # LA32_P
set_property PACKAGE_PIN AJ9 [get_ports {gpio_3_tri_o[1]}]; # LA32_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_3_tri_o[*]}]

# Reserved GPIOs
set_property PACKAGE_PIN AJ14 [get_ports {rsvd_gpio_tri_o[0]}]; # LA12_P
set_property PACKAGE_PIN AK14 [get_ports {rsvd_gpio_tri_o[1]}]; # LA12_N
...
set_property PACKAGE_PIN AF12 [get_ports {rsvd_gpio_tri_o[4]}]; # LA22_P
set_property PACKAGE_PIN AF11 [get_ports {rsvd_gpio_tri_o[5]}]; # LA22_N
set_property PACKAGE_PIN AF6 [get_ports {rsvd_gpio_tri_o[6]}]; # LA25_P
set_property PACKAGE_PIN AF5 [get_ports {rsvd_gpio_tri_o[7]}]; # LA25_N
set_property PACKAGE_PIN AG8 [get_ports {rsvd_gpio_tri_o[8]}]; # LA27_P
set_property PACKAGE_PIN AH8 [get_ports {rsvd_gpio_tri_o[9]}]; # LA27_N
set_property PACKAGE_PIN AJ4 [get_ports {rsvd_gpio_tri_o[10]}]; # LA29_P
set_property PACKAGE_PIN AK4 [get_ports {rsvd_gpio_tri_o[11]}]; # LA29_N
...
set_property PACKAGE_PIN AG18 [get_ports {mipi_phy_if_0_data_p[0]}]; # LA02_P
set_property PACKAGE_PIN AH18 [get_ports {mipi_phy_if_0_data_n[0]}]; # LA02_N
set_property PACKAGE_PIN AC17 [get_ports {mipi_phy_if_0_data_p[1]}]; # LA06_P
set_property PACKAGE_PIN AC18 [get_ports {mipi_phy_if_0_data_n[1]}]; # LA06_N
...
set_property PACKAGE_PIN AF15 [get_ports {mipi_phy_if_1_data_p[0]}]; # LA14_P
set_property PACKAGE_PIN AG15 [get_ports {mipi_phy_if_1_data_n[0]}]; # LA14_N
set_property PACKAGE_PIN AK13 [get_ports {mipi_phy_if_1_data_p[1]}]; # LA15_P
set_property PACKAGE_PIN AK12 [get_ports {mipi_phy_if_1_data_n[1]}]; # LA15_N
...
set_property PACKAGE_PIN AG6 [get_ports {mipi_phy_if_2_data_p[0]}]; # LA17_CC_P
set_property PACKAGE_PIN AG5 [get_ports {mipi_phy_if_2_data_n[0]}]; # LA17_CC_N
set_property PACKAGE_PIN AK7 [get_ports {mipi_phy_if_2_data_p[1]}]; # LA24_P
set_property PACKAGE_PIN AK6 [get_ports {mipi_phy_if_2_data_n[1]}]; # LA24_N
