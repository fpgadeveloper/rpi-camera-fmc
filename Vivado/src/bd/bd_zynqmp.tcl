...
connect_bd_net [get_bd_pins $accel_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
connect_bd_net [get_bd_pins $accel_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
