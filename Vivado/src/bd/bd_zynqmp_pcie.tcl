...
proc create_mipi_pipe { index loc_dict } {
  ...
  connect_bd_net [get_bd_pins video_aclk] [get_bd_pins axi_int_0/M07_ACLK]
  ...
  connect_bd_net [get_bd_pins video_aresetn] [get_bd_pins axi_int_0/M07_ARESETN] -boundary_type upper
