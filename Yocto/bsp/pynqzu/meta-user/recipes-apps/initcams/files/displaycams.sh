...
DISP_RES_W=1920
DISP_RES_H=1080
# Display refresh rate (Hz) — pinned because the PL pixel-clock wizard
# only produces the standard 60 Hz rate; without pinning, modetest picks
# the first mode (often 144 Hz) and the dpsub silently rejects it.
DISP_RATE=60
# Frame rate (fps)
FRM_RATE=30
#--------------------------------------------------------------------------------
